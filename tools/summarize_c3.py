...
DEFAULT_CSV = "exp/C_ddsp/ckps/full_eval_all_C3.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Summarize C3 results to Markdown tables.")
    parser.add_argument("--csv", type=str, default=DEFAULT_CSV,
                        help=f"Path to merged CSV (default: {DEFAULT_CSV})")
    parser.add_argument("--out", type=str, default="",
                        help="Optional path to save the Markdown output (e.g., exp/C_ddsp/ckps/summary.md)")
